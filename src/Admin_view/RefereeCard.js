...
const RefereeCard = (props) => {
    return (
        <div className={`refereeCard shadow-lg rounded-xl p-3 m-4 text-xs grid grid-cols-1 md:grid-cols-8`}>
            <div className="col-span-7 flex flex-col text-left">
                ...
                <div className="grid grid-cols-2 gap-3 mb-2">
                    {/* Information Section */}
                    <div>
                        <h1 className="font-bold">Gender:</h1> <h1>{props.refereeGender}</h1>
                        <h1 className="font-bold">Experience: </h1><h1>{props.refereeExperience} years</h1>
                    </div>
                    <div>
                        <h1 className="font-bold">DoB: </h1><h1>{props.refereeDob}</h1>
                        <h1 className="font-bold">Level: </h1><h1>{props.refereeLevel}</h1>
                    </div>
                </div> 
            </div>
                {/* Configuration */}
            <div className="col-span-1 flex flex-col items-center justify-center space-y-12">
                    ...
                    <button><FontAwesomeIcon className="trash-can-icon icon" icon={faTrashCan} /></button>                  
            </div> 
        </div>
    );
};
